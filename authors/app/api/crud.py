...
class CRUDBase(Generic[CreateSchemaType, UpdateSchemaType]):
    ...
    def remove(self, db: Repository, id: int) -> BaseModel:
...
class CRUDAuthor(CRUDBase[schemas.AuthorCreate, schemas.AuthorUpdate]):
    pass


author = CRUDAuthor(schemas.AuthorInDBBase)
